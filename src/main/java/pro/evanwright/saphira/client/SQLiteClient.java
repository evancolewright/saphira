...
public class SQLiteClient extends DatabaseClient {
    ...
    public SQLiteClient(@NotNull File file) throws DatabaseClientInitializationException, IllegalArgumentException {
        if (!file.getName().endsWith(".db"))
            throw new DatabaseClientInitializationException("Database file must end with the '.db' extension!");
    ...
    /**
     * Runs the 'VACUUM' command and shuts down the {@link Connection} instance.
     *
